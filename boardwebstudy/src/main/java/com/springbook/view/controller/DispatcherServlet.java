...
public class DispatcherServlet extends HttpServlet {
    ...
    private void processV1(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException {
...
//                response.sendRedirect("getBoardList.jsp");
    ...
    private void processV2(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException {
        //1.클라이언트의 요청 path 정보를 추출한다
        String uri = request.getRequestURI();
        String path = uri.substring(uri.lastIndexOf("/"));
